...
interface BidEditFormProps {
  ...
  onSave: (bidId: number, newPrice: number) => void;
}

export default function BidEditForm({ open, onClose, bid, collection, onSave }: BidEditFormProps) {
